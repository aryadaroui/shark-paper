...
\begin{figure}[h]
	...
	\caption{Breakdown of acceleration data recorded at 25 Hz. (a) Static acceleration represents the body position and orientation of the shark due to gravity.  Dynamic acceleration represents the body movements of the shark.}
	\label{accel}
\end{figure}

The data generated by the ADL was labelled manually by viewing the GoPro video recording of each trial and identifying the shark behaviour with the corresponding time-stamps. All data samples that were unlabelled were removed from the dataset. An example of the recorded data from dataset number 7 is shown in Figures 2 and 3.
...
\begin{equation}
	y = \mathrm{arg} \, \mathrm{min}_{y = 1 \ldots n} \sum^n_{j=1}
\end{equation}
