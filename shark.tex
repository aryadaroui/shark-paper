...
\begin{figure}[h!]
	...
	\caption{The plot represents the Fourier Transform of Dynamic X -axis of the collective Feeding data from Datasets 1-7} % Delete this caption and use the first caption for Figure 4 (a) and (b)
	\label{dynamic} 
\end{figure}
\begin{figure}[h!]
	\centering
...
\begin{figure}[h!]
	...
	\caption{The plot represents the Discrete Cosine Transform of Dynamic X -axis of the collective Feeding data from Datasets 1-7} % Delete this caption and use the first caption for Figure 5 (a) and (b)
	\label{dynamic}
\end{figure}
